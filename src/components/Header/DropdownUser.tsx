      ...
      >
        ...
        <span className="h-12 w-12 rounded-full">
          <img
            ...
            src={profile?.image && profile?.image !== "" ? profile.image : profileImage}
            alt="User"
          />
        </span>
        ...
        <div className='bg-balck'>
          <svg
            ...
            className={`hidden fill-current sm:block transform transition-transform ${dropdownOpen ? "rotate-180" : ""}`}
            width="12"
            height="8"
            viewBox="0 0 12 8"
