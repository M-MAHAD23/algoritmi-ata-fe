...
export default function ChatPage({ chatId, title, messages = [] }) {
    ...
    // Redirect to new chat if a new one is created
    useEffect(() => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Append the assistant's message to the new chat messages
            setNewChatMessages((prev) => [
                ...prev,
                {
                    _id: uuid(),
                    role: "assistant",
                    content: data.message, // Assuming the response contains the message in data.message
                },
            ]);
        } catch (error) {
