...
function Landing() {
    ...
    return (
        <>
            ...
            <div className="bg-[#0E0D15] pt-24">
                <div className="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
                    <div className="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
                        <p className="uppercase tracking-loose w-full">Why ATA? Empowering learning through intelligent guidance.</p>
                        <h1 className="my-4 text-5xl font-bold leading-tight">
                            Your personal teaching companion, simplifying complex learning.
                        </h1>
                        <p className="leading-normal text-2xl mb-8">
                            ATA provides interactive, personalized assistance, transforming how students approach and understand
                            challenging concepts. It’s more than support—it's a smarter path to academic success.
                        </p>
                        <button
                            onClick={() => navigate('/signup')}
                    ...
                    <div className="w-full md:w-3/5 py-6 text-center">
                        <img className="w-full md:w-4/5 z-50" src={vector} />
                    </div>
                </div>
            </div>
                    ...
                    <div className="flex flex-wrap">
                        <div className="w-5/6 sm:w-1/2 p-6">
                            ...
                            <p className="text-gray-600 mb-8">
                                ...
                                Students. Replaces traditional teaching assistant roles, addressing bias, focus, and overload issue.
                            </p>
                        </div>
                ...
                <div className="bg-[#0E0D15] container mx-auto flex flex-wrap pt-4 pb-12">
                    ...
                    <div className="flex justify-center align-items">
                        {teamMembers.map((member, index) => (
                            <div key={index} className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink rounded-lg">
