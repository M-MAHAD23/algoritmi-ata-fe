    ...
    const teamMembers = [
        {
            ...
            role: 'Supervisor',
            imgSrc: 'https://media.licdn.com/dms/image/v2/C4D03AQEFh_zzw78iGA/profile-displayphoto-shrink_200_200/profile-displayphoto-shrink_200_200/0/1663251846384?e=1736985600&v=beta&t=hQTNyrl2dA0RvGRlbb2kbrBv-x9CFdyjKgvnJ2wE600',
            description: 'Programming Language Trainer | Project Advisor | TFT Author | Programming Coach | Dev Mentor | Helping individuals to learn and improve computing foundations 🛡️',
            linkedin: 'https://www.linkedin.com/in/dr-nabeel-sabir-khan-8904a4221/'
        },
        {
            name: 'Muhammad Mahad',
            role: 'Software Developer',
            imgSrc: 'https://media.licdn.com/dms/image/v2/D4D03AQFgjwguHhAvHA/profile-displayphoto-shrink_200_200/profile-displayphoto-shrink_200_200/0/1703308146717?e=1736985600&v=beta&t=K5vQ9u7384x6eo2Edoa1A0LuF6CdejLaWZ9YuQ7jGKw',
            description: 'Coding the Future Together! I am a Software Engineer with expertise in Artificial Intelligence, Blockchain, IoT, and Cloud. Let’s keep solving 🛡️',
            linkedin: 'https://www.linkedin.com/in/muhammad-mahad-33806022a/'
        },
        {
            name: 'Muhammad Ahad',
            role: 'Documenter & Designer',
            imgSrc: 'https://media.licdn.com/dms/image/v2/D4D03AQGdkQJHW3tR5A/profile-displayphoto-shrink_200_200/profile-displayphoto-shrink_200_200/0/1729608779381?e=1736985600&v=beta&t=xmafwNQK6vmdyE0RxWBbjace3EpK8zDVY2dS6Vf33nw',
            description: 'Coding the Future Together! I am a Software Engineer with expertise in Python, Designing, and Architecture. Let’s keep solving 🛡️',
            linkedin: 'https://www.linkedin.com/in/muhammad-ahad-9a2b43268/'
        },
        {
            name: 'Muhammad Ahmad',
            role: 'Tester',
            imgSrc: 'https://scontent.flhe13-1.fna.fbcdn.net/v/t39.30808-6/343163896_770153518161561_6751047617848390799_n.jpg?stp=c5.0.306.306a_dst-jpg_s206x206&_nc_cat=108&ccb=1-7&_nc_sid=fe5ecc&_nc_ohc=4we9_5V6cVMQ7kNvgGQ0do5&_nc_zt=23&_nc_ht=scontent.flhe13-1.fna&_nc_gid=A9jLI1gcUzZW0hQMx4yeCyh&oh=00_AYDO8TFNdpW7Flh0m2y8bMZSEFjl8QzfGWvYG_eNfwiMKA&oe=673B3B81',
            description: 'Responsible for ensuring the quality, functionality, and reliability of software through meticulous testing and validation of features and fixes before release 🛡️',
            ...
            <div className="bg-black pt-32 h-[calc(100vh-80px)]">
                <div className="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center space-y-8 md:space-y-0 h-full">
                    <div className="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
                        ...
                        <h1 className="my-4 text-6xl font-bold text-white leading-tight">{visibleText.line2}</h1>
                        <p className="leading-normal text-2xl mb-8">{visibleText.line3}</p>
                        <button
                            onClick={() => navigate('/signup')}
                    ...
                    <div className="w-full md:w-3/5 py-6 text-center overflow-auto">
                ...
                <div className="container max-w-5xl mx-auto m-8">
                    ...
                    <div className="flex flex-wrap items-center">
                        ...
                        >
                            ...
                            <p className="text-gray-600 mb-4"> {/* Reduced bottom margin */}
                                A Web Based Artificial Teaching Assistant aims to create an intelligent system that assists Teachers and
                                Students. Replaces traditional teaching assistant roles, addressing bias, focus, and overload issues.
                            </p>
                        </div>
                    ...
                    <div className="flex flex-wrap flex-col-reverse sm:flex-row items-center">
                        ...
                        >
                            ...
                            <p className="text-gray-600 mb-4"> {/* Reduced bottom margin */}
                                Automated Quiz Management, Chatbot for students, Batch Management, Personalized Learning, Plagiarism
                                Detection, and 24/7 Availability are key features of the ATA.
                            </p>
                        </div>
                    </div>
                ...
                <div className="bg-black container mx-auto flex flex-wrap pt-4 pb-12">
                    ...
                    <div className="flex justify-center">
                        {teamMembers.map((member, index) => (
                            <div key={index} className="w-full sm:w-1/2 md:w-1/3 p-6 flex flex-col flex-grow flex-shrink rounded-lg">
                ...
                <div className="container mx-auto px-8">
                    <div className="w-full flex flex-col md:flex-row py-6">
                        ...
                        <div className="flex items-center mb-6 md:mb-0 md:w-1/4 text-black md:pr-10 md:pl-0">
                            <svg width="50px" height="50px" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fillRule="evenodd" clipRule="evenodd" d="M8 16L3.54223 12.3383C1.93278 11.0162 1 9.04287 1 6.96005C1 3.11612 4.15607 0 8 0C11.8439 0 15 3.11612 15 6.96005C15 9.04287 14.0672 11.0162 12.4578 12.3383L8 16ZM3 6H5C6.10457 6 7 6.89543 7 8V9L3 7.5V6ZM11 6C9.89543 6 9 6.89543 9 8V9L13 7.5V6H11Z" fill="#ffffff" />
                            </svg>
                            <a className="text-white no-underline hover:no-underline font-bold text-2xl lg:text-1xl ml-2" href="#">
                                Artificial Teaching Assistant
                            </a>
                        </div>
                        ...
                        <div className="flex-1 md:w-1/4">
                            ...
                            <ul className="list-reset mb-6">
                                <li className="mt-2 inline-block mr-2 md:block md:mr-0">
                                    <a href="#" className="no-underline hover:underline text-white hover:text-pink-500">Facebook</a>
                                </li>
                                <li className="mt-2 inline-block mr-2 md:block md:mr-0">
                                    <a href="#" className="no-underline hover:underline text-white hover:text-pink-500">LinkedIn</a>
                                </li>
                                <li className="mt-2 inline-block mr-2 md:block md:mr-0">
                                    <a href="#" className="no-underline hover:underline text-white hover:text-pink-500">Twitter</a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="flex-1 md:w-1/4">
                            ...
                            <ul className="list-reset mb-6">
                                <li className="mt-2 inline-block mr-2 md:block md:mr-0">
                                    <a href="#" className="no-underline hover:underline text-white hover:text-pink-500">Official Blog</a>
                                </li>
                                <li className="mt-2 inline-block mr-2 md:block md:mr-0">
                                    <a href="#" className="no-underline hover:underline text-white hover:text-pink-500">About Us</a>
                                </li>
                                <li className="mt-2 inline-block mr-2 md:block md:mr-0">
                                    <a href="#" className="no-underline hover:underline text-white hover:text-pink-500">Contact</a>
                                </li>
                            </ul>
                        </div>
                    </div>
