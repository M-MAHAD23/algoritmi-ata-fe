  ...
  return (
    <Panel>
      ...
      <div className="flex flex-col h-[80vh]">
        ...
        <footer className="bg-black p-4 shadow-md rounded-full flex justify-between items-center">
          <form onSubmit={handleSubmit} className="flex gap-2 w-full">
            <textarea
              value={messageText}
              onChange={(e) => setMessageText(e.target.value)}
              placeholder={generatingResponse ? '' : 'Send a message...'}
              className={`w-full rounded-full resize-none bg-white p-2 pl-10 text-black placeholder-black focus:ring-2 focus:ring-emerald-500 ${
                generatingResponse ? 'opacity-50 cursor-not-allowed' : ''
              }`}
            ...
            <button
              type="submit"
              className={`bg-white text-black p-4 rounded-full hover:bg-gray-500 focus:outline-none ${
                generatingResponse ? 'opacity-50 cursor-not-allowed' : ''
              }`}
